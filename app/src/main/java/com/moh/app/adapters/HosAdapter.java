 ...
 */
public class HosAdapter extends ArrayAdapter<HashMap<String, String>> {

    ArrayList<HashMap<String, String>> actions;
    Context context;

    public HosAdapter(Context context, int resource, List<HashMap<String, String>> actions) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        id.setText(map.get("H_CODE"));
        title.setText(map.get("H_NAME_AR"));
