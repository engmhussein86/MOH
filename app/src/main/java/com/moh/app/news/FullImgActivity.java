...
public class FullImgActivity extends AppCompatActivity {
    ...
    private NetworkImageView mContentView;
...
//        actionBar.hide();
        ...
        mContentView = (NetworkImageView) findViewById(R.id.img);
        post_title = (TextView) findViewById(R.id.dummy_button);
...
//        String encodedURL = "http://www.moh.gov.ps/portal/wp-content/uploads/" + Uri.encode(imageName);
        ...
        imageLoader.get(encodedURL, ImageLoader.getImageListener(mContentView, R.drawable.moh_default, R.drawable.moh_default));
        mContentView.setImageUrl(encodedURL, imageLoader);
